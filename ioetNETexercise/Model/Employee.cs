...
{
    //Class to model employees and operate over them.
    //Contains methods to calculate total worked hours and total payment.
    internal class Employee
    {
        public string name { get; private set; }//Employee's name
        public string strDays { get; private set; }//Raw string containing days and hours worked
        public string[] days { get; private set; }//List of strings hours worked per day

        public Employee(string n, string d)
        { //Constructor receives the name and the raw string
            name = n;
            strDays = d;
            days = d.Split(','); //Gets the list of strings from the raw string
        }
